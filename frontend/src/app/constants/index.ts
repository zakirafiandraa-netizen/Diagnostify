...
export const SCREEN_META: Record<Screen, { title: string; subtitle: string }> = {
  ...
  "offline-category": { title: "Clinical System", subtitle: "Choose a clinical system" },
  ...
  "role-revealed": { title: "Assigned Diagnosis", subtitle: "This is the diagnosis assigned to you" },
